...
<body>
    ...
    <form action="<?php echo U('Category/addCateHandle');?>" method="post">
    <div class="formbody">
    <div class="formtitle"><span>添加栏目</span></div>
    <ul class="forminfo">
    <li><label>栏目标题</label><input name="cname" type="text" class="dfinput" placeholder="请输入栏目名称" /><i>标题不能超过30个字符</i></li>
